 ...
 */
if ( !defined( 'WP_MEMCACHE_PERSISTENT' ) )
	define( 'WP_MEMCACHE_PERSISTENT', true);
/**
 * Value in seconds which will be used for connecting to the daemon. (default 1)
 */
if ( !defined( 'WP_MEMCACHE_TIMEOUT' ) )
	define( 'WP_MEMCACHE_TIMEOUT', 1);
/**
 ...
 * (default 1)
 */
if ( !defined( 'WP_MEMCACHE_WEIGHT' ) )
	define( 'WP_MEMCACHE_WEIGHT', 1);
/**
 * Controls how often a failed server will be retried, the default value is 15 seconds
 */
if ( !defined( 'WP_MEMCACHE_RETRY' ) )
	define( 'WP_MEMCACHE_RETRY', 15);

/**
 * Controls if memcache writes to log
 */
if ( !defined( 'WP_MEMCACHE_LOGGING' ) )
	define( 'WP_MEMCACHE_LOGGING', false);

/**
 * Disable / Enable memcache flushing
 */
if ( !defined( 'WP_MEMCACHE_FLUSHING' ) )
	define( 'WP_MEMCACHE_FLUSHING', true);
